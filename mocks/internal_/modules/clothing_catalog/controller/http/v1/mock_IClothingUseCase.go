...
func (_m *IClothingUseCase) GetAllItems(ctx context.Context, limit int, offset int) ([]entity.Catalog, int, error) {
...
// IClothingUseCase_GetAllItems_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAllItems'
type IClothingUseCase_GetAllItems_Call struct {
	*mock.Call
}
...
//   - limit int
//   - offset int
func (_e *IClothingUseCase_Expecter) GetAllItems(ctx interface{}, limit interface{}, offset interface{}) *IClothingUseCase_GetAllItems_Call {
	return &IClothingUseCase_GetAllItems_Call{Call: _e.mock.On("GetAllItems", ctx, limit, offset)}
}

func (_c *IClothingUseCase_GetAllItems_Call) Run(run func(ctx context.Context, limit int, offset int)) *IClothingUseCase_GetAllItems_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *IClothingUseCase_GetAllItems_Call) Return(_a0 []entity.Catalog, _a1 int, _a2 error) *IClothingUseCase_GetAllItems_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *IClothingUseCase_GetAllItems_Call) RunAndReturn(run func(context.Context, int, int) ([]entity.Catalog, int, error)) *IClothingUseCase_GetAllItems_Call {
	_c.Call.Return(run)
	return _c
}
